...
- You demonstrated a good command of the vocabulary needed for planning a night out with friends. <ContentToggle>你熟练掌握了和朋友筹划夜间外出活动所需的词汇。</ContentToggle>

- demonstrate a good command of <ContentToggle>固定搭配，意为 “熟练掌握”，比单纯的 master 更强调 “通过实际表现体现出的掌握程度”。</ContentToggle>
...
- You express your thoughts in a coherent way, so others are able to understand you and respond appropriately. <ContentToggle>你能条理清晰地表达自己的想法，因此别人能够理解你的意思并作出恰当的回应。</ContentToggle>

- Expressing your thoughts in English requires 3 important aspects: appropriate vocabulary, accurate grammar use and clear thought communication.  <ContentToggle>用英语表达想法需要把握三个重要方面：恰当的词汇选择、准确的语法运用以及清晰的思路传递。</ContentToggle>
...
- World or word? How do you Say?<ContentToggle>你怎么说？(当某个词不会念的时候可以这么问)</ContentToggle>
...
- What are you doing tonight? No, much. Why? <ContentToggle>你今晚打算做什么呀？没什么事。怎么啦？</ContentToggle>

---

- That's correct. Yeah. All right. Let's move on. Put the words in the correct order. <ContentToggle>这个说法是对的。好的，那我们继续。把这些单词按正确的顺序排列。</ContentToggle>

- So we have phrases for suggesting, and phrases for responding. So you have to put the phrases in the correct group, OK?

- Most common, neutral politeness <ContentToggle>最常用、中性礼貌</ContentToggle>
    - Could you give me a minute to think?
- More colloquial and casual <ContentToggle>更口语化、随意</ContentToggle>
    - Give me a sec to think, please. <ContentToggle>（sec = second，非常地道的简略说法）</ContentToggle>
- Slightly more formal, suitable for classrooms/workplaces   <ContentToggle>稍正式一点，适合课堂 / 职场</ContentToggle>
...
- Daily Conversation Version <ContentToggle>日常对话版</ContentToggle>
    - It’s like when you’re thinking, you know, when you’re not really sure what to say next—sometimes you just blurt out something random or use little phrases to pause. <ContentToggle>这就跟你琢磨事儿的时候一样，你懂的，就是你不确定接下来该说啥的时候 —— 有时候你会随口说点什么，或者用些小短语来停顿一下。</ContentToggle>
- Concise Example <ContentToggle>简洁示例版</ContentToggle>
    - It’s like when you’re thinking—you know, when you’re figuring something out—sometimes you say things like “wait a second” or “hmm” without even noticing. <ContentToggle>就像你思考的时候 —— 就是你琢磨明白一件事的过程中 —— 有时候你会不自觉地说 “等一下” 或者 “嗯” 这样的话。</ContentToggle>

---

- You have to describe these picture with a word. So, look at the picture, and then you have to describe it with one word. <ContentToggle>你需要用一个词来描述这些图片。来看看这幅图，然后你得用一个单词描述它。</ContentToggle>

- Ok, so look at the question, and you have to use the words in brackets, Ok? You have to use the words in brackets to respond to the question, Ok? <ContentToggle>好的，来看看这个问题。你得用括号里的单词来作答，好吗？一定要用括号里的词来回应这个问题，听清了吗？</ContentToggle>

- unsure whether it's a phrase or three words that can be freely combined or ordered, how should you ask your teacher? <ContentToggle>不确定是一个短语还是三个可以自由组合或排序的单词时，应该怎么问老师</ContentToggle>

- The most direct way to ask  <ContentToggle>最直接的问法</ContentToggle>
    - Excuse me, is not feel like a fixed phrase, or can these three words be rearranged freely?<ContentToggle>打扰一下，请问 not feel like 是一个固定短语，还是这三个词可以自由排序呀？</ContentToggle>
- More colloquial way of asking questions <ContentToggle>更口语化的问法</ContentToggle>
    - Sorry, just to clarify—are not, feel, like three separate words that we can use in different orders, or do they make up one set phrase? <ContentToggle>不好意思，想确认一下 ——not feel like 这三个词是可以拆分排序的独立单词，还是一个固定搭配呀？</ContentToggle>
- Concise version of the question <ContentToggle>简洁版问法</ContentToggle>
    - Can I ask if not feel like is a fixed phrase, or are these words flexible? <ContentToggle>请问 not feel like 是固定短语，还是这些词的用法比较灵活呀？</ContentToggle>
...
- So here, we have to match the dialogue. So, yeah, so it's a conversation between two people, OK? <ContentToggle>好的，接下来我们要做对话配对练习。嗯，就是两个人之间的一段对话，明白吗？</ContentToggle>

- It's not a sentence. So it's a dialogue, it's a conversation, it's a conversation between two people, so person A and person B, OK? So what does what does person A say? <ContentToggle>这不是单一的句子，它是一段对话，是两个人之间的交谈，也就是 A 方和 B 方的对话，明白吗？那么，A 方会说些什么呢？</ContentToggle>

- OK, let's practice this dialogue together. So, I will be A, and then you will be B. OK?

--- 

- OK, so let's practice planning a night out with friends. So, we are going to do a role play, OK? So, we are roommates, OK? So, I am your roommate, you are my roommate. So, we are going to talk about our evening plans, OK? <ContentToggle>好的，那我们来练习和朋友规划晚间外出活动。我们要进行一场角色扮演，好吗？设定我们是室友，好不好？我是你的室友，你也是我的室友。接下来我们要聊一聊晚上的安排，好吗？</ContentToggle>
...
- It is like raw fish. <ContentToggle>这东西就像生鱼片一样。</ContentToggle>
...
- That we use to make suggestions is what about, ok? Oh, what about the ... <ContentToggle>我们用来提建议的说法里有 what about，好吗？哦，比如可以说 “要不……”</ContentToggle>
...
- You could always + do sth. <ContentToggle>(委婉提议)</ContentToggle>
